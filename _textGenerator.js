...
function textsGenerator(_a) {
    ...
    var CURRENT_CLASSROOM_JOINS = CLASSROOMS_JOINS_LINKS[classroomColor];
    function descriptionGenerator(choosenClassroom) {
        var c = CURRENT_CLASSROOM_JOINS[choosenClassroom];
        var em = choosenClassroom === "INFARTO_ACV" ? "viernes " + viernes + " a las 18hs"
            :
